        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <h3 className="text-xl font-bold mb-4 flex items-center gap-3 text-white">
              <img src="/logo.png" alt="Hedrize - Premium Head Hunting Solutions" className="w-[150px] h-auto rounded-lg" />
            </h3>
            ...
            <div className="flex gap-4">
              {['LinkedIn'].map((social) => (
                <a
                  key={social}
                  href="https://www.linkedin.com/company/hedrize"
                  aria-label={`Visit Hedrize on ${social}`}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-blue-100/70">
              <li className="flex items-center gap-2">
                ...
                <a href="mailto:info@hedrize.com" className="hover:text-white transition-colors">
                  info@hedrize.com
                </a>
              </li>
              <li className="flex items-center gap-2">
                <span aria-hidden="true">📞</span>
                <a href="tel:+6281776900656" className="hover:text-white transition-colors">
                  +62-8177-6900-656
                </a>
              </li>
